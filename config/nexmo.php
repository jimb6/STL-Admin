...
return [
    ...
    */
    ...
    'api_key'    => function_exists('env') ? env('NEXMO_KEY', 'Master (6f8a36ad)') : 'Master (6f8a36ad)',
    'api_secret' => function_exists('env') ? env('NEXMO_SECRET', 'FugZxZ5RxuO2X4xg') : 'FugZxZ5RxuO2X4xg',
