...
class ApiClusterController extends Controller
{
    ...
    {
        Auth::user()->can('list-clusters', Cluster::class);
...
//        }
    ...
    {
        Auth::user()->can('create-clusters', Cluster::class);
    ...
    {
        Auth::user()->can('view-clusters', $cluster);
//        return view('app.clusters.show', compact('cluster'));
    ...
    {
        Auth::user()->can('update-clusters', $cluster);
...
//        return view('app.clusters.edit', compact('cluster'));
    ...
    {
        Auth::user()->can('delete-clusters', $cluster);
        $cluster->delete();
        return response([], 204);
    }
