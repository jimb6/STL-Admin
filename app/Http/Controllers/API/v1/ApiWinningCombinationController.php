...
class ApiWinningCombinationController extends Controller
{
    ...
    {
        Auth::user()->can('list-winning-combinations', WinningCombination::class);
    ...
    {
        Auth::user()->can('create-winning-combinations', WinningCombination::class);
    ...
    {
        Auth::user()->can('view-winning-combinations', WinningCombination::class);
    ...
    {
        Auth::user()->can('update-winning-combinations', $winningCombination);
        $validated = $request->validate([
            'password' => 'required',
            'combination' => 'required',
            'game' => 'required',
    ...
    {
        Auth::user()->can('update-winning-combinations', WinningCombination::class);
    ...
    {
        Auth::user()->can('delete-winning-combinations', $winningCombination);
