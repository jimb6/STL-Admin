...
class ApiCommissionController extends Controller
{
    ...
    {
        $this->authorize('create-commissions', Commission::class);
...
//        return redirect()->route('clusters.edit', $commission);
    ...
    {
        $this->authorize('view-commissions', $commission);
//        return view('app.clusters.show', compact('cluster'));
    ...
    {
        $this->authorize('update-commissions', $commission);
...
//        return view('app.clusters.edit', compact('cluster'));
    ...
    {
        $this->authorize('delete-commissions', $commission);
        $commission->delete();
        return response([], 204);
    }
}
