...
import DefaultConfiguration from "../../components/games/DefaultConfiguration";
import DaysAvailability from "../../components/games/DaysAvailability";
import ControlCombinations from "../../components/games/ControlCombinations";
...
export default {
    ...
    data: () => ({
        ...
        pageTitle: this.game + " LOTTO DRAW RESULTS",
